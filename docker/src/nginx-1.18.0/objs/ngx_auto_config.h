#define NGX_CONFIGURE " --prefix=/usr/local/nginx --with-http_dav_module --add-module=/opt/nginx-dav-ext-module-master"

#ifndef NGX_COMPILER
#define NGX_COMPILER  "gcc 10.3.1 20211027 (Alpine 10.3.1_git20211027) "
#endif
